...
i = 0
# 文件路径
jsonl_file_path = r'/data/zhaoshuofeng/workplace/hongan_data/研报+OCR/paddleOCR/data_folder/train.jsonl'
txt_file_path = r'/data/zhaoshuofeng/workplace/hongan_data/研报+OCR/paddleOCR/data_folder/high_similarity_filenames.txt'
output_jsonl_path = r'/data/zhaoshuofeng/workplace/hongan_data/研报+OCR/paddleOCR/data_folder/train_v2.jsonl'
